...
type DownloadPlansArticleProps = {
  ctaHref?: string
  ctaLabel?: string
}

export function DownloadPlansArticle({
  ctaHref = '/#download-plans',
  ctaLabel = 'Download Free Wood Working Plans',
}: DownloadPlansArticleProps) {
  const isExternal = ctaHref.startsWith('http')

  return (
    <>
      <p className="download-plans__lead">
        If you’ve ever stared at a stack of lumber and wondered what to build next, free woodworking plans can be the
        shortcut from idea to finished project.
      </p>
      ...
      <p>
        Using a proven plan helps eliminate guesswork and helps you build faster with better results.
      </p>
      ...
      <p>A workbench is often the first serious build for new woodworkers.</p>
      ...
      <p>Coffee tables are one of the most downloaded beginner woodworking plans.</p>
      ...
      <p>
        Floating shelves, wall organizers, and storage boxes are popular because they use minimal materials.
      </p>
      ...
      <p>Outdoor furniture remains a high-demand woodworking category.</p>
      ...
      <p>Many DIYers use free plans to build products they later sell.</p>
      ...
      <p>
        Free woodworking plans are one of the best ways to improve your skills without reinventing every project from
        scratch.
      </p>
